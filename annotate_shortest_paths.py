...
def annotate_numpy(endpoint='widipedia', sample='distribution', entities_path='development_set.jl'):
    '''
...
def annotate_json(entities_path='development_set.jl'):
    ...
    while True:
        ...
        with open(entities_path, 'r') as entities_file, open('top5_widipedia/%s.jl' % limit, 'w') as outfile:
